"""Phone-number normalization to E.164 for consistent contact lookup.
...
because the trunk's origination number format is "E.164/National". Contacts are
...
(the product serves US contacts); already-E.164 inputs (incl. international) pass
...
def to_e164(raw: str | None) -> str | None:
    ...
    - anything else -> ``+`` + digits (best effort; if it matches no contact, the
