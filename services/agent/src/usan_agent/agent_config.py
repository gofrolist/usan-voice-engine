...
DEFAULT_AGENT_CONFIG = AgentConfig(
    prompts=PromptsConfig(
        ...
        checkin_flow_instructions=(
            ...
            "SAFETY FIRST — if at ANY moment the elder expresses thoughts of suicide or "
            ...
            "SCAM AWARENESS — if the elder describes a suspicious request (a caller or "
            ...
            "check with\nfamily first.\n\n"
            "If the elder asks not to be called anymore (or to be taken off the list), warmly "
            "acknowledge\nit, let them know you'll stop the calls, and call "
            "`register_opt_out`. If they would like the\nhelpful phone numbers by text, call "
            "`send_info_sms`.\n\n"
            "SPANISH — if the elder is speaking Spanish or asks to be helped in Spanish, don't "
